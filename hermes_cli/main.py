...
Usage:
    ...
    hermes uninstall           Uninstall NiuMa Agent
...
def cmd_whatsapp(args):
    ...
    if (session_dir / "creds.json").exists():
        ...
        if wa_mode == "bot":
            ...
            print()
            print("  Tip: Agent responses are prefixed with '◆ NiuMa Agent'")
        else:
            print("  Next steps:")
            print("    1. Start the gateway:  hermes gateway")
...
def cmd_version(args):
    """Show version."""
    print(f"NiuMa Agent v{__version__} ({__release_date__})")
...
def _update_via_zip(args):
    """Update NiuMa Agent by downloading a ZIP archive.
...
def cmd_update(args):
    """Update NiuMa Agent to the latest version.
    ...
    if is_managed():
        managed_error("update NiuMa Agent")
        return
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="niuma",
        description="NiuMa Agent - AI assistant with tool-calling capabilities",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    niuma                        Start interactive chat
    niuma chat -q "Hello"       Single query mode
...
""",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with NiuMa Agent",
    )
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure NiuMa Agent with an interactive wizard. "
    ...
    status_parser = subparsers.add_parser(
        ...
        description="Display status of NiuMa Agent components",
    )
    ...
    doctor_parser = subparsers.add_parser(
        ...
        description="Diagnose issues with NiuMa Agent setup",
    )
    ...
    debug_parser = subparsers.add_parser(
        ...
        description="Debug utilities for NiuMa Agent. Use 'hermes debug share' to "
...
""",
    ...
    config_parser = subparsers.add_parser(
        ...
        description="Manage NiuMa Agent configuration",
    )
    ...
    update_parser = subparsers.add_parser(
        "update",
        help="Update NiuMa Agent to the latest version",
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall NiuMa Agent",
        description="Remove NiuMa Agent from your system. Can keep configs/data for reinstall.",
    )
    ...
    acp_parser = subparsers.add_parser(
        "acp",
        help="Run NiuMa Agent as an ACP (Agent Client Protocol) server",
        description="Start NiuMa Agent in ACP mode for editor integration (VS Code, Zed, JetBrains)",
    )

    def cmd_acp(args):
        """Launch NiuMa Agent as an ACP server."""
        try:
    ...
    dashboard_parser = subparsers.add_parser(
        ...
        description="Launch the NiuMa Agent web dashboard for managing config, API keys, and sessions",
    )
